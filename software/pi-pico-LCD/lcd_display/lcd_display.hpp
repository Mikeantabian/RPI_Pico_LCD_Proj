...
class LCDdisplay {
    ...
    public:
    LCDdisplay(int bit4_pin, int bit5_pin, int bit6_pin, int bit7_pin, int rs_pin,
                int e_pin, int width, int depth);
    LCDdisplay(int bit4_pin, int bit5_pin, int bit6_pin, int bit7_pin, int rs_pin,
                int e_pin, int bl_pin, int width, int depth);
    ...
    void displayChar(uint8_t location);
};
